...
const Input = ({ label, name, type, placeholder, options, span, value, ...props }) => {
    const inputClassName = `block w-full rounded-md border border-gray-300 bg-gray-100 p-2 text-sm text-gray-900 shadow-md shadow-gray-300 outline-none focus:border-2 focus:border-primary-500 focus:bg-white md:text-base 2xl:p-2.5`;
